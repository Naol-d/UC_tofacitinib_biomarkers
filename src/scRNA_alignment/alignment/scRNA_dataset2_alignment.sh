...
#SBATCH --nodes=1
#SBATCH --mem=70G
#SBATCH --output=/scratch/prj/bmb_tofacitinib/research_project/scRNA_alignment/scripts/slurms/scRNA_alignment/dataset2/scRNA_alignment-%A-%a.out
...
FASTQ_DIR="${BASE_DATA_DIR}/originals/scRNA/dataset_2/renamed_fastq"
